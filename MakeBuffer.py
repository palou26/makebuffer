...
class MakeBuffer:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&MakeBuffer')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('MakeBuffer', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/MakeBuffer/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Make a buufer'),
            callback=self.run,
